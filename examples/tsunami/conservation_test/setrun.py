...
#------------------------------
    ...
    # Area on radius=1 earth : 0.90689968211710725 

    flat_domain = False
    earth_radius = 63.004508148519896    # 6367.5e3

    rundata = setgeo(rundata, flat_domain, earth_radius)
    ...
    # coordinates taken from chile2010, but will have flat bottom
    clawdata.lower[0] = -120.0
    ...
    rundata.gaugedata.gauges.append([1, -75., -30.0, 0., 1.e10])
    rundata.gaugedata.gauges.append([2, -65., -55.0, 0., 1.e10])
...
#-------------------
def setgeo(rundata,flat_domain,earth_radius):
#-------------------
    """
    ...
    geo_data.earth_radius = earth_radius   # input argument
    ...
    topo_data.topofiles.append([1, 1, 10, 0., 1.e10, 'flat.topotype1'])
