...
#--------------------------
    ...
    plotdata.kml_index_fname = "TetonDam_short"  # name for .kmz and .kml files ["_GoogleEarth"]
    ...
    plotfigure.kml_xlimits = [-112.3895, -111.24]
    ...
    # If amr refinement ratios set to [2,4,4]; max_level = 4
    # figsize*dpi = [55,24]*4*4*4 = [3520,1536]
    plotfigure.kml_figsize = [352.0, 153.6]
